...
Створити emun із днями тижня та використовуючи switch виведіть наступні повідомлення
...
Практика №2:
1. Зробіть абстрактний клас MusicStyles, який міститиме метод playMusic()
...
Практика №3:
1. Зробіть інтерфейс Smartphones, який має містити методи call(), sms(), internet()
2. Зробіть класи, які його імплементують: Androids, iPhones.
3. Androids повинні також імплементувати LinuxOS, айфони повинні імплементувати iOS
4. Створіть екземпляри кожного виду у мейн-класі
